...
-- CreateEnum
CREATE TYPE "RATTRIBUTES" AS ENUM ('CUNNING', 'CUTENESS', 'RATTITUDE');
...
CREATE TABLE "Solo_Encounter_Results" (
    ...
    CONSTRAINT "Solo_Encounter_Results_pkey" PRIMARY KEY ("player_id","encounter_id")
);
...
CREATE TABLE "Gauntlet_Attempts" (
    ...
    CONSTRAINT "Gauntlet_Attempts_pkey" PRIMARY KEY ("gauntlet_id","player_id")
);
